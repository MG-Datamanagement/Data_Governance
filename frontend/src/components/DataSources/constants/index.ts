...
export const MOCK_QUERY_RESULTS = {
  users: {
    ...
    rows: [
      { id: 1, email: "john@example.com", name: "John Doe", created_at: "2025-01-15 10:30:00", is_active: true },
      { id: 2, email: "jane@example.com", name: "Jane Smith", created_at: "2025-02-20 14:22:00", is_active: true },
      { id: 3, email: "bob@example.com", name: "Bob Wilson", created_at: "2025-03-10 09:15:00", is_active: false },
      { id: 4, email: "alice@example.com", name: "Alice Brown", created_at: "2025-04-05 16:45:00", is_active: true },
      { id: 5, email: "charlie@example.com", name: "Charlie Davis", created_at: "2025-05-12 11:00:00", is_active: true },
    ],
    executionTime: 145,
  },
  orders: {
    ...
    rows: [
      { id: 101, user_id: 1, total_amount: 299.99, status: "completed", order_date: "2025-08-15 10:30:00" },
      { id: 102, user_id: 2, total_amount: 149.50, status: "pending", order_date: "2025-09-20 14:22:00" },
      { id: 103, user_id: 1, total_amount: 599.00, status: "completed", order_date: "2025-10-10 09:15:00" },
      { id: 104, user_id: 3, total_amount: 89.99, status: "cancelled", order_date: "2025-10-15 16:45:00" },
      { id: 105, user_id: 4, total_amount: 1299.99, status: "completed", order_date: "2025-10-20 11:00:00" },
    ],
    executionTime: 89,
  },
  products: {
    ...
    rows: [
      { id: 1, name: "Laptop Pro 15", price: 1299.99, category_id: 1, stock_quantity: 45 },
      { id: 2, name: "Wireless Mouse", price: 29.99, category_id: 2, stock_quantity: 230 },
      { id: 3, name: "USB-C Cable", price: 19.99, category_id: 2, stock_quantity: 500 },
      { id: 4, name: "Monitor 27\"", price: 399.99, category_id: 1, stock_quantity: 78 },
      { id: 5, name: "Keyboard Mechanical", price: 149.99, category_id: 2, stock_quantity: 120 },
    ],
    executionTime: 67,
  },
};
