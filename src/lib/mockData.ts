...
export const MOCK_MODEL_LIST: ModelListItem[] = [
  ...
  {
    id: "model-6",
    name: "Legacy Sentiment Analyzer",
    version: "v1.5",
    source: "Internal",
    task: "Classification",
    status: "Deprecated",
...
export const MOCK_MODEL_METADATA: ModelMetadata = {
  ...
  tags: [
    { name: "Finance", color: "blue" },
    { name: "Retail", color: "purple" },
    { name: "XGBoost", color: "orange" },
  ],
  riskTier: "Medium Risk",
  dataPrivacyReview: {
    status: "Passed",
    lastReviewed: "Feb 20, 2026",
  },
  biasFairnessEval: {
    status: "Passed",
  ...
  datasets: [
    {
      name: "retail_transactions_master",
      purpose: "Training",
      classification: "Confidential",
    },
    {
      name: "customer_profiles_v2",
      purpose: "Training",
      classification: "PII",
    },
    {
      name: "q4_eval_holdout",
      purpose: "Evaluation",
