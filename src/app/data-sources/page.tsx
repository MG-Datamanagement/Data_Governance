...
export default function DataSourcesModule() {
  ...
  const handleRunSource = (sourceId: string) => {
    console.log('Running source:', sourceId);
  ...
  const handleSaveSource = () => {
    ...
    if (wizardMode === 'edit' && editingSourceId) {
      setSources(sources.map(s => s.id === editingSourceId ? newSource : s));
    } else {
      ...
      <div className="min-h-screen bg-gray-50 p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-4 flex items-center justify-between">
            ...
            <button className="flex items-center gap-2 text-indigo-600 hover:text-indigo-700 mr-2">
                ...
                {sources.map((source) => (
                  <React.Fragment key={source.id}>
                    <tr className="border-b border-gray-100 hover:bg-gray-50">
                      ...
                      <td className="py-4 px-4">
                        <div className="flex items-center gap-2">
                          <button className="p-2 hover:bg-gray-100 rounded" title="Copy URN">
              ...
              <div className="p-6 space-y-6">
                ...
                <div>
                  ...
                  <div className="bg-gray-900 text-gray-100 p-4 rounded font-mono text-xs overflow-x-auto">
                    <pre>~~~~ Execution Summary - RUN_INGEST ~~~~{'\n'}Execution finished with errors.{'\n'}{'{'}"exec_id": "019c9b8d-7e1c-441d-95dd-9402ba689145",{'\n'}"infos": ["2025-12-07 18:06:37.224316 INFO: Starting execution for task with name=RUN_INGEST",{'\n'}          "2025-12-07 18:06:50.728119 INFO: Failed to execute 'datahub ingest', exit code 1"...</pre>
  ...
  const canProceedStep2 = configMode === 'yaml' ? yamlContent.trim().length > 0 :
    (selectedSource?.id === 'postgres' ? connectionConfig.host && connectionConfig.username && connectionConfig.database : true);
