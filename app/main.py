...
try:
    ...
    from .api.v1.governance_rules import router as governance_router
    ...
    app.include_router(governance_router, prefix=f"{settings.api_v1_prefix}/governance-rules", tags=["governance-rules"])
